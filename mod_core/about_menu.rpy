...
screen mod_about():
    ...
    viewport id "autor":
        ...
        text _("Мод позволяющей легко добавлять свои поделки в игру. На данный момент инструмент поддержывает добавление своих эпизодов, инструментов. Также можно добавлять кнопки в меню игры и меню мода. \n\nДокументацию и примеры можно найти в {a=https://google.com}{size=+5}GitHub-е{/size}{/a}"):
            size 50
            color "#fff"
            font "font/russia.ttf"
